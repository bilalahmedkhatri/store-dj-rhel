...
def get_mock_shop_filters() -> dict:
    return {
        ...
        "facet_groups": {
            "brand": ["e-sahulat", "Urban Fit", "Nova Wear"],
...
def get_mock_about_data() -> dict:
    return {
        "hero_title": "About e-sahulat",
        "hero_subtitle": "Crafting quality products with passion and precision since 2025",
        "story_title": "Our Story",
        "story_paragraphs": [
            "Founded in 2025, e-sahulat started with a simple mission: to bring high-quality, stylish products to customers who value both form and function.",
...
def get_mock_privacy_policy_data() -> dict:
    return {
        ...
        "sections": [
            ...
            {"title": "Contact", "body": "For privacy questions or SBP CPD related queries, email privacy@e-sahulat.com."},
        ],
    }
...
def get_mock_terms_data() -> dict:
    return {
        ...
        "sections": [
            ...
            {"title": "Contact", "body": "For legal questions, email legal@e-sahulat.com."},
        ],
    }
...
def get_mock_refund_policy_data() -> dict:
    return {
        ...
        "sections": [
            ...
            {"title": "Support", "body": "Need help? Contact returns@e-sahulat.com."},
        ],
    }
...
def get_mock_shipping_policy_data() -> dict:
    return {
        ...
        "sections": [
            ...
            {"title": "Support", "body": "Shipping questions: shipping@e-sahulat.com."},
        ],
    }
...
def get_mock_payment_methods_data() -> dict:
    return {
        ...
        "security_note": "Payments are encrypted in transit. For payment issues, contact support@e-sahulat.com.",
    }
